...
(function() {
  ...
  var reqSrc = thisSrc.replace(/[^/]*$/, 'require.js');
  ...
  define(['./BelayComms', './utils', './CapServer', './CapTunnel', './common'],
      function(BelayComms, utils, CapServer, CapTunnel, common) {
    ...
    function setUpBelayTunnel(belayPort) {
      ...
      tunnel.setOutpostHandler(function(outpostData) {
        ...
        ui = {
          resize: function() { }, // TODO(mzero): old API, remove
