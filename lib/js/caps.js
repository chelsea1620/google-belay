...
var CAP_EXPORTS = (function() {
  ...
  var newUUIDv4 = (function() {
    ...
    if(typeof window !== "undefined" && window !== null && 'crypto' in window) {
    ...
    this.privateInterface = (function(me) {
      return Object.freeze({
        invoke: function(ser, method, data, success, failure) {
          ...
          if (me.instanceID && instID == me.instanceID) {
            me._getImpl(ser).invoke(method, data, success, failure);
            return;
          } else {
  ...
  var CapTunnel = function(port) {
    ...
    this.tunnelServer.setResolver(function(instID) { return me.sendInterface; });
    ...
    var SEND_INTERVAL = 5000; // send every 5s, ping if needed
