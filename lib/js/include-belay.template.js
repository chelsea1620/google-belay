...
(function(){
  ...
  window.belay = {
    ...
    portReadyHandlers: [],
    onPortReady: function(callback) {
      if(window.belay.portReadyHandlers) {
        window.belay.portReadyHandlers.push(callback);
      } else {
        window.setTimeout(callback, 0);
      }
    },
    portReady: function() {
      var handlers = window.belay.portReadyHandlers;
      delete window.belay.portReadyHandlers;
